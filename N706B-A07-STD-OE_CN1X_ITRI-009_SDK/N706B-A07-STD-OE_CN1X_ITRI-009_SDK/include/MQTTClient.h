...
#define MAX_MESSAGE_HANDLERS 30 /* redefinable - how many subscriptions do you want? */
#endif
...
int nwy_MQTTConnect(MQTTClient* c, MQTTPacket_connectData* options);
int nwy_MQTTPublish(MQTTClient* c, const char* topicName, MQTTMessage* message);
void nwy_mqtt_release_resource(MQTTClient* c);
