...
const char *nwy_hal_pm_get_boot_reason_str(void) {
    ...
    switch(reason) {
        case 0x00000001: return "Power Key";
        case 0x00000010: return "Pin Reset";
        case 0x00000100: return "Alarm";
        case 0x00001000: return "Charge In";
        case 0x00010000: return "Watchdog";
        case 0x00100000: return "Wakeup";
        default: return "Unknown";
    }
}

bool nwy_hal_pm_get_time(nwy_time_t *time_out, int *timezone_out) {
    if (!time_out || !timezone_out) return false;
...
bool nwy_hal_pm_date_to_timestamp(const nwy_time_t *time_in, nwy_timeval_t *timestamp_out) {
    if (!time_in || !timestamp_out) return false;
...
bool nwy_hal_pm_timestamp_to_date(const nwy_timeval_t *timestamp_in, nwy_time_t *time_out) {
    if (!timestamp_in || !time_out) return false;
